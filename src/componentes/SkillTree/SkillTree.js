    ...
    >
      <SimpleGrid columns={columnCount} gap={2}  spacing={8}>
        ...
        />
          ...
          descricaoDrawer={"Ao explorar os conceitos da linguagem C, aprendi sobre estruturas de controle, como loops e condicionais, e também sobre tipos de dados, operadores e funções. Esses fundamentos me permitiram criar programas simples que executam tarefas específicas e interagem diretamente com o hardware do computador."}
